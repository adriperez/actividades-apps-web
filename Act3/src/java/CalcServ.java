...
public class CalcServ extends HttpServlet {
            ...
            throws ServletException, IOException 
    {
        ...
        if(str.equals("suma"))
            ...
            out.println("<h1>El resultado de la resta es:"+(x-y)+"</h1>");
        else if(str.equals("multiplicar"))
            out.println("<h1>El resultado de la multiplicacion es:"+(x*y)+"</h1>");
        else if (str.equals("dividir"))
            out.println("<h1>El resultado de la suma es:"+(x+y)+"</h1>");
